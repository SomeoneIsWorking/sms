...
public:
	...
	// Retail GMSE01 bodies are 0x80144840 and 0x801441e0 respectively. The
	// recomp renderer's interpolation seam uses these identities; the
	// SMS_NATIVE_PLATFORM path still needs the bodies below carried through
	// GCConsole2.cpp before it can serve as a gauge-motion oracle.
