...
TMarDirector::TMarDirector()
    ...
    , mPerformListPreEntry(new TPerformList)
    , mPerformListGraffito(new TPerformList)
    , mPerformListPollution(new TPerformList)
    , mPerformListDrawBufGroup(new TPerformList)
